              ...
              <el-container>
                ...
                <el-main>
                  ...
                  <div class="toDay_lists lists" v-if="tab1">
                    <el-row :gutter="8">
                      <el-col :xs="12" :sm="8" :md="6" :lg="6" :xl="6"  class="list" v-for="(item,index) in toDayLists" v-bind:key="index">
                        <div class="grid-content bg-purple">
                          ...
                          <div class="list_content">
                            ...
                            <div class="content">
                              ...
                              <p>
                                <span>地点：</span>
                                <span>{{item.hotelName}}{{item.location}}</span>
                              </p>
                  ...
                  <div class="stranger_lists lists" v-if="tab2">
                    <el-row :gutter="8">
                      <el-col :xs="12" :sm="8" :md="6" :lg="6" :xl="6"  class="list" v-for="(item,index) in strangerLists" v-bind:key="index">
                        <div class="grid-content bg-purple">
                          <div class="imgs">
                            <div class="nowImg"><img :src="item.facial_pic" alt="" @click="bigImgShow(item.facial_pic)"></div>
                            <div class="idCacrdImg" v-if="item.most_similar_pic"><img :src="item.most_similar_pic" alt=""  @click="bigImgShow(item.most_similar_pic)"></div>
                  ...
                  <div class="white_lists lists" v-if="tab3">
                    <el-row :gutter="8">
                      <el-col :xs="12" :sm="8" :md="6" :lg="6" :xl="6"  class="list" v-for="(item,index) in whiteLists" v-bind:key="index">
                        <div class="grid-content bg-purple">
                          <div class="imgs">
                            <div class="nowImg"><img :src="item.facial_pic" alt="" @click="bigImgShow(item.facial_pic)"></div>
                            <div class="idCacrdImg" v-if="item.most_similar_pic"><img :src="item.most_similar_pic" alt=""  @click="bigImgShow(item.most_similar_pic)"></div>
                  ...
                  <div class="ailve_lists lists" v-if="tab4">
                    <el-row :gutter="8">
                      <el-col :xs="12" :sm="8" :md="6" :lg="6" :xl="6"  class="list" v-for="(item,index) in aliveLists" v-bind:key="index">
                        <div class="grid-content bg-purple">
                          <div class="imgs">
                            <div class="nowImg"><img :src="item.facial_pic" alt="" @click="bigImgShow(item.facial_pic)"></div>
                            <div class="idCacrdImg" v-if="item.most_similar_pic"><img :src="item.most_similar_pic" alt=""  @click="bigImgShow(item.most_similar_pic)"></div>
